...
var swqExport = (function(root) {
    ...
    Quiz.prototype._buildQuestionHTML = function(question, questionElement) {
        ...
        switch (question.type) {
            ...
            case 'true/false':
            case 'boolean':
                optionsHTML = '<label class="swq-option"><input type="radio" name="' + questionName + '" value="True"><span>True</span></label>' +
                             '<label class="swq-option"><input type="radio" name="' + questionName + '" value="False"><span>False</span></label>';
                break;
            case 'text':
    ...
    Quiz.prototype._handleNext = function() {
        ...
        this.state.userAnswers[question.id] = { answer: answer, isCorrect: isCorrect };
    ...
    Quiz.prototype._collectAnswer = function() {
        ...
        switch (question.type) {
            ...
            case 'select-multiple':
                ...
                return Array.prototype.map.call(checkedBoxes, function(cb) { return cb.value; });
            case 'text':
            case 'number':
    ...
    Quiz.prototype._isAnswerCorrect = function(question, userAnswer) {
        ...
        switch (question.type) {
            case 'select-multiple':
                ...
                correctAnswers = correctAnswers.map(function(s) { return String(s).trim(); }).sort();
